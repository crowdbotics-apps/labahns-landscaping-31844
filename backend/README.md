...
## Project Structure
    ...
    ├── labahns_landscaping_31844  # Django project configurations
...
1. Clone this repo and `cd labahns_landscaping_31844`
...
2. Clone this repo and `cd labahns_landscaping_31844`
